...
class OmniMath {
    ...
    std::vector<double> jerkSaturationFilter(
        std::vector<double> previous_calculated_velocities,
        std::vector<double> current_calculated_velocities,
        double max_jerk) {
    ...
    std::vector<double> calculateVelocities(
        ...
        std::vector<double> previous_measurement,
        ...
        bool enable_moving_average) {
            ...
            if (enable_moving_average) {
                ...
                return moving_average.mean.data();
            }
            else return calculated_velocities;
        }
